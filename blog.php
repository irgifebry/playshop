...
<section class="legal-section">
    <div class="container">
        ...
        <p class="page-subtitle">Update promo, event, dan tips top up game.</p>

        <div class="legal-content">
            <div class="legal-block">
                <h2>Coming soon</h2>
                <p>Halaman blog ini masih versi awal. Konten bisa ditambah via CMS/DB di tahap berikutnya.</p>
            </div>
        </div>
    </div>
</section>
